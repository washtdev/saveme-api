        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, TokenModel_1.default.create({ user: user._id })];
                case 2:
                    token = _a.sent();
                    if (!token) {
                        return [2 /*return*/, response.status(400).json({ message: 'failed to generate token!' })];
                    }
                    config = {
                    ...
                    return [4 /*yield*/, MailConfig_1.default.sendMail(config)];
                case 3:
                    _a.sent();
